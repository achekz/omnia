      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-8">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-display font-bold text-gray-900">Help Center</h1>
          </div>
          <p className="text-gray-600 text-lg">
            Find answers to common questions and learn how to get the most from Omni AI
          </p>
        </div>

        {/* Quick Contact */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <button className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200 hover:border-purple-300 transition-all text-left group">
          ...
          <button className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 hover:border-blue-300 transition-all text-left group">
            <div className="flex items-start justify-between mb-2">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <p className={`font-semibold ${selectedCategory === null ? "text-purple-900" : "text-gray-900"}`}>
                All Topics
              </p>
            </button>
            {categories.map((category) => (
              ...
              >
                <div className={`mb-2 ${selectedCategory === category.name ? "text-purple-600" : "text-gray-600"}`}>
                  {category.icon}
                </div>
                <p className={`font-semibold ${selectedCategory === category.name ? "text-purple-900" : "text-gray-900"}`}>
                  {category.name}
                </p>
              </button>
            ))}
        ...
        {/* Footer CTA */}
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl border border-purple-200 p-8 text-center">
