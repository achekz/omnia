      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">Manage your student finances, loans, and daily expenses.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
            ...
            <p className="text-3xl font-bold text-gray-900 mt-4 relative">$2,450.00</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
            ...
            <p className="text-3xl font-bold text-gray-900 mt-4 relative">$1,200.00</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
            ...
            <p className="text-3xl font-bold text-gray-900 mt-4 relative">$850.00</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-2 relative">
              ...
              <h3 className="text-sm font-semibold text-gray-600">Remaining Budget</h3>
            </div>
            <p className="text-3xl font-bold text-gray-900 mt-4 relative">$350.00</p>
          </div>
        </div>
              ...
              {[
                ...
                <div key={i} className="p-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-4">
                    <div className={`p-3 rounded-xl ${tx.amount > 0 ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-100 text-gray-600'}`}>
              ...
              {[
                ...
                <div key={i}>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="text-gray-500">${item.amount} / ${item.total}</span>
                  </div>
