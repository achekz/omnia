      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">Organize your classes, assignments, and exams.</p>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm min-h-[400px] flex flex-col">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  <button className="p-1.5 hover:bg-gray-100 rounded-md transition-colors text-gray-500">&lt;</button>
                  <button className="px-3 py-1.5 bg-gray-100 text-gray-900 text-sm font-medium rounded-md">Today</button>
                  <button className="p-1.5 hover:bg-gray-100 rounded-md transition-colors text-gray-500">&gt;</button>
                </div>
              </div>
              
              <div className="flex-1 border-t border-gray-100 pt-6 flex items-center justify-center text-gray-400">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    ...
                    <span className={`text-sm ${goal.done ? 'text-gray-400 line-through' : 'text-gray-700 font-medium'}`}>
                      {goal.title}
                    </span>
                  </div>
                ))}
