  ...
  return (
    <ModuleLayout activeItem="notifications">
      <div className="p-6 md:p-8">
        <div className="mb-6">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-violet-600">Temps réel</p>
          <h1 className="mt-2 text-3xl font-display font-bold text-gray-950">Notifications</h1>
          <p className="mt-2 text-gray-500">Alertes stockées dans MongoDB et mises à jour via Socket.IO.</p>
        </div>

        <div className="space-y-3">
          {isFetching && !notifications.length ? (
            <div className="rounded-2xl border border-gray-200 bg-white p-6 text-sm text-gray-500">Chargement des notifications...</div>
            ...
            <div className="rounded-2xl border border-dashed border-gray-300 bg-white p-10 text-center">
              ...
              <p className="font-semibold text-gray-950">Aucune notification pour le moment</p>
              <p className="mt-1 text-sm text-gray-500">Les alertes réelles du moteur de règles apparaîtront ici.</p>
            </div>
          )}
        </div>
      </div>
