...
const MODULES: NavModule[] = [
  {
    ...
    items: [
      { id: "dashboard", label: "Tableau de bord", icon: <BarChart3 className="w-4 h-4" />, path: "/dashboard/company" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "insights", label: "Analyses IA", icon: <Sparkles className="w-4 h-4" />, path: "/insights" },
    ],
  },
  {
    id: "admin-workspace",
    ...
    items: [
      { id: "dashboard", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" />, path: "/admin/dashboard" },
      { id: "users", label: "Utilisateurs", icon: <Users className="w-4 h-4" />, path: "/admin/users" },
      { id: "presences", label: "Présences", icon: <Calendar className="w-4 h-4" />, path: "/admin/presences" },
      { id: "admin-tasks", label: "Tâches", icon: <CheckCircle2 className="w-4 h-4" />, path: "/admin/tasks" },
      { id: "rules", label: "Moteur de règles", icon: <ShieldCheck className="w-4 h-4" />, path: "/admin/rules" },
      { id: "ai", label: "Assistant IA", icon: <Bot className="w-4 h-4" />, path: "/ai" },
      { id: "insights", label: "Analyses IA", icon: <Sparkles className="w-4 h-4" />, path: "/insights" },
    ],
  },
  {
    ...
    items: [{ id: "cat-dash", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" /> }],
  },
  {
    ...
    items: [
      { id: "dashboard", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" />, path: "/dashboard/employee" },
      { id: "presence", label: "Présence", icon: <Calendar className="w-4 h-4" />, path: "/presence" },
      { id: "tasks", label: "Mes tâches", icon: <CheckCircle2 className="w-4 h-4" />, path: "/tasks" },
      { id: "performances", label: "Performance", icon: <BarChart3 className="w-4 h-4" />, path: "/performance" },
      { id: "insights", label: "Analyses IA", icon: <Sparkles className="w-4 h-4" />, path: "/insights" },
      { id: "ia", label: "Assistant IA", icon: <Bot className="w-4 h-4" />, path: "/ai" },
    ],
  },
  {
    ...
    items: [
      { id: "dashboard", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" />, path: "/comptable/dashboard" },
      { id: "presence", label: "Présence", icon: <Calendar className="w-4 h-4" />, path: "/presence" },
      { id: "tasks", label: "Mes tâches", icon: <CheckCircle2 className="w-4 h-4" />, path: "/tasks" },
      { id: "insights", label: "Analyses IA", icon: <Sparkles className="w-4 h-4" />, path: "/insights" },
      { id: "ai", label: "Assistant IA", icon: <Bot className="w-4 h-4" />, path: "/ai" },
  ...
  },
  {
    ...
    allowedProfiles: ["company"],
    items: [{ id: "crm-dash", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" /> }],
  },
  {
    id: "inventaire",
    label: "Inventaire",
    ...
    allowedProfiles: ["company"],
    items: [{ id: "inv-dash", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" /> }],
  },
  {
    id: "paie",
    label: "Paie-TN",
    ...
    allowedProfiles: ["company", "cabinet"],
    items: [
      { id: "dashboard", label: "Tableau de bord", icon: <BarChart3 className="w-4 h-4" />, path: "/paie/dashboard" },
  ...
  },
  {
    ...
    allowedProfiles: ["company"],
    items: [{ id: "btp-dash", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" /> }],
  },
  {
    ...
    items: [
      { id: "dashboard", label: "Tableau de bord", icon: <LayoutDashboard className="w-4 h-4" />, path: "/stagiaire/dashboard" },
      { id: "presence", label: "Présence", icon: <Calendar className="w-4 h-4" />, path: "/presence" },
      { id: "performances", label: "Performance", icon: <BarChart3 className="w-4 h-4" />, path: "/performance" },
      { id: "tasks", label: "Mes tâches", icon: <CheckCircle2 className="w-4 h-4" />, path: "/tasks" },
      { id: "ia", label: "Assistant IA", icon: <Bot className="w-4 h-4" />, path: "/ai" },
